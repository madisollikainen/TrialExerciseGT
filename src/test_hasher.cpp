 ...
 *
 *	The test_hasher commandline tool, which implements 
 ...
 * 
 *	test_hasher is the same tool as hasher, with the exception of 
 *	using the identity_hash function as the hash function. Thus
 *	the outputs of this tool will be much more easy to track.
 */
...
int main( int argc, char **argv )
{
	...
	std::string NAME_HEAD = "Guardtime trial excersise by Madis Ollikainen. The test version uses an idendity function for hashing.\nVersion: " + std::string(VERSION);
	...
	// Using the It enables and myHashMerge functions 
